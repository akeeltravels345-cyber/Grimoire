...
const styles = StyleSheet.create({
  ...
  manifIntention: { fontSize: 14, color: theme.textPrimary, lineHeight: 20, fontStyle: 'italic', marginBottom: 12, fontFamily: theme.fonts.serif },
  ...
  resultNote: { fontSize: 13, color: theme.textPrimary, lineHeight: 19, fontFamily: theme.fonts.serif },
  ...
  emptyText: { fontSize: 14, color: theme.textSecondary, textAlign: 'center', lineHeight: 20, paddingHorizontal: 20, fontFamily: theme.fonts.serif },
});
