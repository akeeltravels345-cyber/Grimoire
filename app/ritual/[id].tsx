...
const styles = StyleSheet.create({
  ...
  ritualName: { fontSize: 24, fontWeight: '700', color: theme.textPrimary, textAlign: 'center', marginBottom: 12, lineHeight: 30 },
  ...
  statusBadgeLabel: { fontSize: 16, fontWeight: '800', letterSpacing: 0.3, textTransform: 'uppercase' },
  ...
  statLabel: { fontSize: 11, fontWeight: '500', color: theme.textMuted, textTransform: 'uppercase' },
  ...
  ingredientText: { fontSize: 14, color: theme.textSecondary },
  ...
  manifIntention: { fontSize: 14, color: theme.textPrimary, lineHeight: 21, fontStyle: 'italic' },
  ...
  emptyJournalText: { fontSize: 16, fontWeight: '600', color: theme.textPrimary, marginBottom: 4 },
  emptyJournalSub: { fontSize: 13, color: theme.textSecondary },
  ...
  journalNotes: { fontSize: 14, color: theme.textPrimary, lineHeight: 21 },
